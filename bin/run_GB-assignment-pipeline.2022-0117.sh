...
path_data="./data"
# bam="kga0/processed.mate-paired.mm10.normal.chrX.sorted.bam"
bam="kga0/processed.mate-paired.mm10.normal.chrX.bam"
...
thresh_SNP="1"
thresh_Q="30"
path_results="./results/kga0/2022-0117_segregated_reads.thresh_SNP_${thresh_SNP}.thresh_Q_${thresh_Q}"
