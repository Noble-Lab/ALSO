...
# echo "${wcCAST}"  # 1573032
# echo $(("${wcCAST}" / 4))  # 393258
#
# wcBamCAST=$(samtools view "${bamCAST}" | wc -l)
# echo "${wcBamCAST}"  # 393258
#
# #  Nmasked
# wcNmasked=$(cat "${cigarNmasked}" | wc -l)
# echo "${wcNmasked}"  # 1636848
# echo $(("${wcNmasked}" / 4))  # 409212
#
# wcBamNmasked=$(samtools view "${bamNmasked}" | wc -l)
# echo "${wcBamNmasked}"  # 409212
#
...
cat "${cigarNmasked/.txt/.munged.txt}" | wc -l  # 409212
