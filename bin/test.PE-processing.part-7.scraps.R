...
# test.even <- dplyr::full_join(
#     uni.AS.pmin, uni.joint.GB, by = "coordinate.even"
# )
# (test.even$coordinate.even %notin% uni.AS.pmin$coordinate.even) %>% table()
# (test.even$coordinate.even %notin% uni.joint.GB$coordinate.even) %>% table()
# 
# test.odd.2 <- dplyr::full_join(
#     uni.joint.GB, uni.AS.pmin, by = "coordinate.odd"
# )
# (test.odd.2$coordinate.odd %notin% uni.AS.pmin$coordinate.odd) %>% table()
# (test.odd.2$coordinate.odd %notin% uni.joint.GB$coordinate.odd) %>% table()
# 
# joint.subset <- joint[
#     joint$coordinate.odd %notin% uni.joint.GB$coordinate.odd, 
# ]
# joint[joint$coordinate.odd %notin% uni.AS.pmin$coordinate.odd, ]
