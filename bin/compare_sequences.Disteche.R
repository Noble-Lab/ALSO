...
compareSequences129 <- function(bam, row) {
    ...
    Mmusculus129S1SvImJ %>% getSeq(., names = gr_liftOver_mm10_to_129)
    Mmusculus129Nmasked %>% getSeq(., names = gr)
    Mmusculus129Inserted %>% getSeq(., names = gr)
    
    Mmusculus129S1SvImJ %>% BSgenome::getSeq(., names = gr)
    Mmusculus129Nmasked %>% BSgenome::getSeq(., names = gr_liftOver_129_to_mm10)
    Mmusculus129Inserted %>% BSgenome::getSeq(., names = gr_liftOver_129_to_mm10)
...
compareSequencesCAST <- function(bam, row) {
    ...
    MmusculusCASTEiJ %>% getSeq(., names = gr_liftOver_mm10_to_CAST)
    MmusculusCASTNmasked %>% getSeq(., names = gr)
    MmusculusCASTInserted %>% getSeq(., names = gr)
    
    MmusculusCASTEiJ %>% BSgenome::getSeq(., names = gr)
    MmusculusCASTNmasked %>% BSgenome::getSeq(., names = gr_liftOver_CAST_to_mm10)
    MmusculusCASTInserted %>% BSgenome::getSeq(., names = gr_liftOver_CAST_to_mm10)
