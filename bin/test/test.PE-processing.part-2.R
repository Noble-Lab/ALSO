...
#  For "ambiguous" and "mated," assign FALSE to NAs
# operation <- paste0(
#     variable[!stringr::str_detect(variable, "unmated")], "$discrepancy[",
#         "is.na(",
#             variable[!stringr::str_detect(variable, "unmated")],
#             "$discrepancy",
#         ")",
#     "]", " <- ", "FALSE"
...
#QUESTION Can I delete the commented-out code below?
# #  Merging rows ---------------------------------------------------------------
# 
# #  See this URL:
